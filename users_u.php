        ...
        <div class="container col-6 mx-auto">
            ...
            <form  class="col-6" action="update_users.php?id=<?php echo $_SESSION['user']['id']; ?>" method="POST">
                ...
                <div class="form-group">
                    <label for="thumbnail"><strong>Photo de profil :</strong></label>
                    <input type="text" id="thumbnail" name="thumbnail" class="form-control" value="<?php echo $_SESSION['user']['thumbnail']; ?>" required>
                </div>

                <div class="form-group">
                    <label for="first_name"><strong>Votre prénom :</strong></label>
                    <input type="text" id="first_name" name="first_name" class="form-control" value="<?php echo $_SESSION['user']['first_name']; ?>" required>
                </div>

                <div class="form-group">
                    <label for="last_name"><strong>Votre nom :</strong></label>
                    <input type="text" id="last_name" name="last_name" class="form-control" value="<?php echo $_SESSION['user']['last_name']; ?>" required>
                </div>

                <div class="form-group">
                    <label for="email"><strong>Votre email :</strong></label>
                    <input type="text" id="email" name="email" class="form-control" value="<?php echo $_SESSION['user']['email']; ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="phone_number" name="phone_number" class="form-control" value="<?php echo $_SESSION['user']['phone_number']; ?>" required>
                </div>
